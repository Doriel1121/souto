cordova.define(
  "cordova-plugin-facebook4.FacebookConnectPluginBrowser",
  function (require, exports, module) {
    ...
    exports.browserInit = function browserInit(appId, version, s) {
      console.warn(
        "browserInit is deprecated and may be removed in the future"
      );
      console.trace();
    };
    ...
    if (window.location.protocol === "file:") {
      ...
      window.fbAsyncInit = function () {
        FB.init({
          appId: 318617532783602, // null is populated by the cordova after_prepare hook
          xfbml: true,
          version: "v2.7",
        });
