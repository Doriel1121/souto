...
export default class HomePage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      todoTickets: [
        {
          id: 0,
          title: "Deploy the document1",
          description:
            "Being able to deploy the tests right after push to master and after that remove all the code",
        },
        {
          id: 1,
          title: "Deploy the document",
          description:
            "Being able to deploy the tests right after push to master and after that remove all the code",
        },
        {
          id: 2,
          title: "Deploy the document2",
          description:
            "Being able to deploy the tests right after push to master and after that remove all the code",
        },
        {
          id: 3,
          title: "Deploy the do3",
          description:
            "Being able to deploy the tests right after push to master and after that remove all the code",
        },
      ],
  ...
  renderBoardById = (id) => {
    ...
    return (
      <Board tickets={tickets} moveTicket={this.moveTicket} name={boardName} />
    );
  };
